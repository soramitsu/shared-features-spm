...
public protocol SnapshotHotBootBuilderProtocol {
    func startHotBoot(chainsTypesUrl: URL, chainsUrl: URL)
}

public final class SnapshotHotBootBuilder: SnapshotHotBootBuilderProtocol {
    ...
    public func startHotBoot(chainsTypesUrl: URL, chainsUrl: URL) {
