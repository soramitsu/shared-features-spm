...
final class XcmDependencyContainerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        chainRegistry.getRuntimeProviderChainIdUsedRuntimePathsRuntimeItemReturnValue = TestData.runtimeProvider
        chainRegistry.getConnectionForReturnValue = TestData.connectionChain
        
        self.chainRegistry = chainRegistry
        
        service = XcmDependencyContainer(chainRegistry: chainRegistry,
    ...
    func testPrepareDeps() async throws {
        ...
        XCTAssertEqual(chainRegistry?.getRuntimeProviderChainIdUsedRuntimePathsRuntimeItemCallsCount, 1)
