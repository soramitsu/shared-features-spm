...
final class SeedCreatorTests: XCTestCase {
    ...
    func testCreateSeed() {
        ...
        // Act
        do {
            let result = try seedCreator.createSeed(derivationPath: TestData.derivationPath,
                                                    strength: .entropy128,
                                                    ethereumBased: false,
                                                    cryptoType: .sr25519)
    ...
    func testDeriveSeed() {
        ...
        // Act
        do {
            let result = try seedCreator.deriveSeed(mnemonicWords: TestData.mnemonicString,
...
extension SeedCreatorTests {
    enum TestData {
        ...
        static let junctionResult = JunctionResult(chaincodes: [],
                                                   password: nil)
    }
    
    func performSeedCreatorTest(ethereumBased: Bool,
                                cryptoTypes: [CryptoType]) throws {
