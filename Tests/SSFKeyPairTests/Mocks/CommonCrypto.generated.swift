...
class CommonCryptoMock: CommonCrypto {
    ...
    var getQuerySeedDerivationPathCryptoTypeEthereumBasedReceivedArguments: (seed: Data, derivationPath: String, cryptoType: CryptoType, ethereumBased: Bool)?
    var getQuerySeedDerivationPathCryptoTypeEthereumBasedReceivedInvocations: [(seed: Data, derivationPath: String, cryptoType: CryptoType, ethereumBased: Bool)] = []
    var getQuerySeedDerivationPathCryptoTypeEthereumBasedReturnValue: AccountQuery!
    var getQuerySeedDerivationPathCryptoTypeEthereumBasedClosure: ((Data, String, CryptoType, Bool) throws -> AccountQuery)?

    func getQuery(seed: Data, derivationPath: String, cryptoType: CryptoType, ethereumBased: Bool) throws -> AccountQuery {
    ...
    var getJunctionResultFromEthereumBasedReceivedArguments: (derivationPath: String, ethereumBased: Bool)?
    var getJunctionResultFromEthereumBasedReceivedInvocations: [(derivationPath: String, ethereumBased: Bool)] = []
    ...
    func getJunctionResult(from derivationPath: String, ethereumBased: Bool) throws -> JunctionResult? {
    ...
    var generateKeypairFromChaincodesCryptoTypeIsEthereumReceivedArguments: (seed: Data, chaincodes: [Chaincode], cryptoType: CryptoType, isEthereum: Bool)?
    var generateKeypairFromChaincodesCryptoTypeIsEthereumReceivedInvocations: [(seed: Data, chaincodes: [Chaincode], cryptoType: CryptoType, isEthereum: Bool)] = []
    var generateKeypairFromChaincodesCryptoTypeIsEthereumReturnValue: (publicKey: Data, secretKey: Data)!
    var generateKeypairFromChaincodesCryptoTypeIsEthereumClosure: ((Data, [Chaincode], CryptoType, Bool) throws -> (publicKey: Data, secretKey: Data))?

    func generateKeypair(from seed: Data, chaincodes: [Chaincode], cryptoType: CryptoType, isEthereum: Bool) throws -> (publicKey: Data, secretKey: Data) {
    ...
    var createKeypairFactoryIsEthereumBasedReceivedArguments: (cryptoType: CryptoType, isEthereumBased: Bool)?
    var createKeypairFactoryIsEthereumBasedReceivedInvocations: [(cryptoType: CryptoType, isEthereumBased: Bool)] = []
