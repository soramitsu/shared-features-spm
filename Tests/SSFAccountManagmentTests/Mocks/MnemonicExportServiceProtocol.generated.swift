...
class MnemonicExportServiceProtocolMock: MnemonicExportServiceProtocol {
    ...
    var fetchExportDataForWalletAccountsReturnValue: [MnemonicExportData]!
    var fetchExportDataForWalletAccountsClosure: ((MetaAccountModel, [ChainAccountInfo]) -> [MnemonicExportData])?
    ...
    var fetchExportDataForAddressChainWalletReturnValue: MnemonicExportData!
    var fetchExportDataForAddressChainWalletClosure: ((String, ChainModel, MetaAccountModel) throws -> MnemonicExportData)?
