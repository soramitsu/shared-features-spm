...
public class XcmExtrinsicBuilderProtocolMock: XcmExtrinsicBuilderProtocol {
    ...
    public var buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathCallsCount =
        0
    public var buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathCalled: Bool {
        buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathCallsCount > 0
    }

    public var buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathReceivedArguments: (
        fromChainModel: ChainModel,
        currencyId: String,
        destChainModel: ChainModel,
        accountId: AccountId?,
    ...
    public var buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathReceivedInvocations: [
        (
            fromChainModel: ChainModel,
            currencyId: String,
            destChainModel: ChainModel,
    ...
    public var buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathClosure: (
        (
            ChainModel,
            String,
            ChainModel,
    ...
    public func buildBridgeProxyBurn(
        ...
        if let error =
            buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathThrowableError
        {
            throw error
        }
        buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathCallsCount += 1
        buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathReceivedArguments =
            (
                fromChainModel: fromChainModel,
                currencyId: currencyId,
                destChainModel: destChainModel,
        ...
        buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathReceivedInvocations
            .append((
                fromChainModel: fromChainModel,
                currencyId: currencyId,
                destChainModel: destChainModel,
        ...
        return try buildBridgeProxyBurnFromChainModelCurrencyIdDestChainModelAccountIdAmountPathClosure
            .map { try $0(
                fromChainModel,
                currencyId,
                destChainModel,
