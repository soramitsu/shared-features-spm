...
final class StorageRequestPerformerTests: XCTestCase {
    ...
    func testEncodedSingleRequest() async throws {
        ...
        let storageUpdate = StorageUpdate(
            ...
            changes: [[
                "0x21f5afab8d010000",
                "0x582bdd02e8b7e3a97da353f92954db770676e7f07eddf2d08cb9f2430aaf4429",
            ]] // key, value
        )
        let performer = StorageRequestPerformerDefault(
            runtimeService: polkadotRuntimeService,
    ...
    func testNMapSingleRequest() async throws {
        ...
        let request = StorageRequestMock(
            ...
            storagePath: StoragePathMock.custom(
                moduleName: "staking",
    ...
    func testEncodedMultipleRequest() async throws {
        let account1 =
            try Data(
                hexStringSSF: "0x582bdd02e8b7e3a97da353f92954db770676e7f07eddf2d08cb9f2430aaf4420"
            )
        let account2 =
            try Data(
                hexStringSSF: "0x582bdd02e8b7e3a97da353f92954db770676e7f07eddf2d08cb9f2430aaf4411"
            )
        let account3 =
            try Data(
                hexStringSSF: "0x582bdd02e8b7e3a97da353f92954db770676e7f07eddf2d08cb9f2430aaf4412"
            )
        let storageUpdate = StorageUpdate(
            blockHash: nil,
            changes: [
                [
                    "0x21f5afab8d010000",
                    "0x582bdd02e8b7e3a97da353f92954db770676e7f07eddf2d08cb9f2430aaf4420",
                ],
                [
                    "0x21f5afab8d010001",
                    "0x582bdd02e8b7e3a97da353f92954db770676e7f07eddf2d08cb9f2430aaf4411",
                ],
                [
                    "0x21f5afab8d010002",
                    "0x582bdd02e8b7e3a97da353f92954db770676e7f07eddf2d08cb9f2430aaf4412",
                ],
            ] // key, value
        )
        let performer = StorageRequestPerformerDefault(
    ...
    func testEncodedMultipleRequestCache() async throws {
        ...
        let stream: AsyncThrowingStream<[AccountId?], Error> = await performer.performMultiple(
            request,
            withCacheOptions: .onAll
        )
