...
public init() {}
    ...
    public var bridgeProxyBurnCurrencyIdDestChainModelAccountIdAmountPathClosure: ((String, ChainModel, AccountId, BigUInt, XcmCallPath) -> RuntimeCall<BridgeProxyBurnCall>)?

    public func bridgeProxyBurn(currencyId: String, destChainModel: ChainModel, accountId: AccountId, amount: BigUInt, path: XcmCallPath) -> RuntimeCall<BridgeProxyBurnCall> {
        ...
        return bridgeProxyBurnCurrencyIdDestChainModelAccountIdAmountPathClosure.map({ $0(currencyId, destChainModel, accountId, amount, path) }) ?? bridgeProxyBurnCurrencyIdDestChainModelAccountIdAmountPathReturnValue
    }
