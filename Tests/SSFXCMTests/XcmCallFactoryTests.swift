...
final class XcmCallFactoryTests: XCTestCase {
    ...
    func testReserveNativeToken() {
        ...
        // act
        let runtimeCall = factory?.reserveNativeToken(version: version,
    ...
    func testXTokensTransfer() {
        ...
        // act
        let runtimeCall = factory?.xTokensTransfer(version: version,
                                                   accountId: accountId,
    ...
    func testXTokensTransferMultiasset() async throws {
        ...
        // act
        let runtimeCall = try await factory?.xTokensTransferMultiasset(version: version,
    ...
    func testXTokensTransferMultiassetWithError() async throws {
        ...
        // act
        do {
            try await factory?.xTokensTransferMultiasset(version: version,
                                                         assetSymbol: assetSymbol,
                                                         accountId: accountId,
                                                         fromChainModel: fromChainModel,
                                                         destChainModel: destChainModel,
            ...
            // assert
            XCTAssertEqual(error.localizedDescription, XcmError.noAvailableXcmAsset(symbol: assetSymbol).localizedDescription)
        }
    }
    ...
    func testPolkadotXcmLimitedReserveTransferAssets() async throws {
        ...
        // act
        let runtimeCall = try await factory?.polkadotXcmLimitedReserveTransferAssets(fromChainModel: fromChainModel,
                                                                                     version: version,
                                                                                     assetSymbol: assetSymbol,
                                                                                     accountId: accountId,
                                                                                     destChainModel: destChainModel,
    ...
    func testPolkadotXcmLimitedReserveTransferAssetsWithError() async throws {
        ...
        // act
        do {
            try await factory?.polkadotXcmLimitedReserveTransferAssets(fromChainModel: fromChainModel,
                                                                       version: version,
                                                                       assetSymbol: assetSymbol,
                                                                       accountId: accountId,
                                                                       destChainModel: destChainModel,
    ...
    func testBridgeProxyBurn() {
        ...
        // act
        let runtimeCall = factory?.bridgeProxyBurn(fromChainModel: fromChainModel,
                                                   currencyId: currencyId,
                                                   destChainModel: destChainModel,
                                                   accountId: accountId,
                                                   amount: amount,
...
extension XcmCallFactoryTests {
    enum TestData {
        static let multilocation = AssetMultilocation(id: "0",
                                                      symbol: "0",
                                                      interiors: [.onlyChild])
        
        static let chain = XcmChain(xcmVersion: .V1,
        ...
        static let node = ChainNodeModel(url: XcmConfig.shared.tokenLocationsSourceUrl,
                                         name: "node")
        
        static let model = ChainModel(rank: 0,
                                      disabled: false,
                                      chainId: "0",
                                      paraId: "0",
                                      name: "model",
