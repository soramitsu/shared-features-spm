...
public protocol RuntimeFilesOperationFactoryProtocol {
    /**
...
public final class RuntimeFilesOperationFactory {
    ...
    public init(repository: FileRepositoryProtocol, directoryPath: String) {
...
extension RuntimeFilesOperationFactory: RuntimeFilesOperationFactoryProtocol {
    public func fetchCommonTypesOperation() -> CompoundOperationWrapper<Data?> {
        fetchFileOperation(for: "common-types")
    }

    public func fetchChainsTypesOperation() -> CompoundOperationWrapper<Data?> {
        fetchFileOperation(for: "chains-types")
    }

    public func fetchChainTypesOperation(for chainId: ChainModel.Id) -> CompoundOperationWrapper<Data?> {
        fetchFileOperation(for: "\(chainId)-types")
    }

    public func saveCommonTypesOperation(
        data closure: @escaping () throws -> Data
    ) -> CompoundOperationWrapper<Void> {
        saveFileOperation(for: "common-types", data: closure)
    }

    public func saveChainsTypesOperation(
        data closure: @escaping () throws -> Data
    ) -> CompoundOperationWrapper<Void> {
        saveFileOperation(for: "chains-types", data: closure)
    }

    public func saveChainTypesOperation(
