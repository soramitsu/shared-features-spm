...
public init() {}
    ...
    public var buildBridgeProxyBurnCurrencyIdDestChainModelAccountIdAmountPathClosure: ((String, ChainModel, AccountId, BigUInt, XcmCallPath) -> ExtrinsicBuilderClosure)?

    public func buildBridgeProxyBurn(currencyId: String, destChainModel: ChainModel, accountId: AccountId, amount: BigUInt, path: XcmCallPath) -> ExtrinsicBuilderClosure {
        ...
        return buildBridgeProxyBurnCurrencyIdDestChainModelAccountIdAmountPathClosure.map({ $0(currencyId, destChainModel, accountId, amount, path) }) ?? buildBridgeProxyBurnCurrencyIdDestChainModelAccountIdAmountPathReturnValue
    }
