...
public class CommonCryptoMock: CommonCrypto {
    ...
    public var getQuerySeedDerivationPathCryptoTypeEthereumBasedReceivedArguments: (
        seed: Data,
        derivationPath: String,
        cryptoType: CryptoType,
        ethereumBased: Bool
    )?
    public var getQuerySeedDerivationPathCryptoTypeEthereumBasedReceivedInvocations: [(
        seed: Data,
        derivationPath: String,
        cryptoType: CryptoType,
        ethereumBased: Bool
    ...
    public var getQuerySeedDerivationPathCryptoTypeEthereumBasedClosure: ((
        Data,
        String,
        CryptoType,
        Bool
    ...
    public var getJunctionResultFromEthereumBasedReceivedArguments: (
        derivationPath: String,
        ethereumBased: Bool
    )?
    public var getJunctionResultFromEthereumBasedReceivedInvocations: [(
        derivationPath: String,
        ethereumBased: Bool
    )] = []
    public var getJunctionResultFromEthereumBasedReturnValue: JunctionResult?
    public var getJunctionResultFromEthereumBasedClosure: (
        (String, Bool) throws
            -> JunctionResult?
    )?
    ...
    public var generateKeypairFromChaincodesCryptoTypeIsEthereumReceivedArguments: (
        seed: Data,
        chaincodes: [Chaincode],
        cryptoType: CryptoType,
        isEthereum: Bool
    )?
    public var generateKeypairFromChaincodesCryptoTypeIsEthereumReceivedInvocations: [(
        seed: Data,
        chaincodes: [Chaincode],
        cryptoType: CryptoType,
        isEthereum: Bool
    )] = []
    public var generateKeypairFromChaincodesCryptoTypeIsEthereumReturnValue: (
        publicKey: Data,
        secretKey: Data
    )!
    public var generateKeypairFromChaincodesCryptoTypeIsEthereumClosure: ((
        Data,
        [Chaincode],
        CryptoType,
        Bool
    ...
    public var createKeypairFactoryIsEthereumBasedReceivedArguments: (
        cryptoType: CryptoType,
        isEthereumBased: Bool
    )?
    public var createKeypairFactoryIsEthereumBasedReceivedInvocations: [(
        cryptoType: CryptoType,
        isEthereumBased: Bool
    )] = []
    public var createKeypairFactoryIsEthereumBasedReturnValue: KeypairFactoryProtocol!
    public var createKeypairFactoryIsEthereumBasedClosure: (
        (CryptoType, Bool)
